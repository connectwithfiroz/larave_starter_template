...
<div id="ngo-donation-popup" class="ngo-popup">
    ...
    <form class="ngo-popup-form" action="/donate" method="POST" id="donationForm">
        <input type="hidden" name="for" value="Not Selected">
        <div class="row">
            <div class="col-lg-6">
                <label for="donor-name">Name:</label>
                <input type="text" id="donor-name" name="donor-name" required pattern="[A-Za-z\s]{3,}" title="Only letters and spaces, minimum 3 characters">
            </div>
            <div class="col-lg-6">
                <label for="donor-number">Mo. Number:</label>
                <input type="text" id="donor-number" name="donor-number" required pattern="\d{10}" title="Enter a valid 10-digit mobile number">
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <input type="number" id="donation-amount" name="donation-amount" required min="1" step="0.01" title="Amount must be greater than 0">
            </div>
        </div>
            ...
            <ul>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                            ...
                            <li><a href="dontaion.html">Donation Details</a></li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                            ...
                            <li><a href="acchivment.html">Achievements</a></li>
        ...
        <div class="container-fluid px-0 px-md-5">
            <div class="menu-area">
                ...
                <div class="header-button">
                        ...
                        <a href="dontaion.html" class="th-btn style3 d-lg-block d-none"><i

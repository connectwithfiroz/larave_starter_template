                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="feature-card">
                        ...
                        <form action="{{ route('donations.search.post') }}" method="GET" class="d-flex justify-content-center">
                            <input type="text" name="donation_id" class="form-control p-1 border border-primary" placeholder="Enter Donation ID" required>
                            <button type="submit" class="btn btn-primary btn-sm" style="background-color: var(--theme-color)">Search</button>
                        </form>
                        <a class="link-btn style2" href="#">Verify Donation Certificate <i class="fa-solid fa-arrow-up-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>

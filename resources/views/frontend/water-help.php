...
@section('section')
 ...
 <div class="breadcumb-wrapper position-relative">
    ...
    <div class="d-none d-md-block">
        <img src="{{ asset('frontend/assets/img/banner-26-jan/Water_Supply_Program.png') }}"
    ...
    <div class="d-block d-md-none">
        <img src="{{ asset('frontend/assets/img/mobile-imag/water.png') }}"
             class="img-fluid w-100"

            ...
            <div class="swiper-slide">
                <div class="hero-inner" data-bg-src="{{ asset('frontend/img/banner/hero-banner-1.jpg') }}"data-overlay="black4" data-opacity="5">
                    <div class="hero-bg-shape1-1">
                        <img src="{{ asset('frontend/hero/hero-bg-shape1-1.png') }}" alt="img">
                    </div>
                    <div class="container">
...
<section class="feature-area-1 position-relative space-bottom">
    <div class="feature-bg-wrap" data-bg-src="{{ asset('frontend/bg/gray-bg2.png') }}" data-mask-src="{{ asset('frontend/bg/feature-bg-mask-1.png') }}">
        ...
        <div class="row gy-30 gx-30">
            <div class="col-xl-3 col-lg-4">
                <div class="feature-card">
                    <div class="feature-card-bg-shape">
                        <img src="{{ asset('frontend/shape/feature-card-bg-shape1-1.png') }}" alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/press-pass.png') }}" alt="icon">
                    </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="feature-card">
                    ...
                    <div class="box-icon">
                        <img src="{{ asset('frontend/email.png') }}" alt="icon">
                    </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="feature-card">
                    ...
                    <div class="box-icon">
                        <img src="{{ asset('frontend/certificate.png') }}" alt="icon">
                    </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="feature-card">
                    ...
                    <div class="box-icon">
                        <img src="{{ asset('frontend/donation.png') }}" alt="icon">
                    </div>
...
<!--============================== Service Area  ==============================-->
<section class="overflow-hidden space" id="service-sec" data-bg-src="{{ asset('frontend/bg/gray-bg1.png') }}" data-overlay="gray" data-opacity="6">
    <div class="shape-mockup service-bg-shape1-1 d-xxl-inline-block d-none" data-top="15%" data-left="0">
        <div class="color-masking">
            <div class="masking-src" data-mask-src="{{ asset('frontend/shape/hand-shape1.png') }}"></div>
            <img src="{{ asset('frontend/shape/hand-shape1.png') }}" alt="img">
        </div>
    </div>
        ...
        <div class="row gy-30 gx-30 justify-content-center">
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/youth.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/boy.png') }}" alt="Icon">
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/woman.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/women.png') }}" alt="Icon">
                    </div>
                    <div class="box-content">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/RuralEmpowerment.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/lake.png') }}" alt="Icon">
                    </div>
                    <div class="box-content">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/EnvironmentalHelp.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/volunteering.png') }}" alt="Icon">
                    </div>
                    <div class="box-content">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/EducationEmpowerment.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/education.png') }}" alt="Icon">
                    </div>
                    <div class="box-content">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="service-card style2">
                    <div class="box-thumb">
                        <img src="{{ asset('frontend/cherety/health.jpg') }}"alt="img">
                    </div>
                    <div class="box-icon">
                        <img src="{{ asset('frontend/empowerment.png') }}" alt="Icon">
                    </div>
                    <div class="box-content">
...
<div class="overflow-hidden space" id="about-sec">
    <div class="shape-mockup about-bg-shape2-1 jump-reverse d-lg-inline-block d-none" data-top="10%" data-right="5%">
        <img src="{{ asset('frontend/shape/heart-shape1.png') }}" alt="shape">
    </div>
    <div class="shape-mockup about-bg-shape3-1 jump" data-bottom="20%" data-right="5%">
        <div class="color-masking2">
            <div class="masking-src" data-mask-src="{{ asset('frontend/shape/about_shape3_1.png') }}"></div>
            <img src="{{ asset('frontend/shape/about_shape3_1.png') }}" alt="img">
        </div>
    </div>
    <div class="container">
        <div class="row gy-60 align-items-center">
            <div class="col-xl-6">
                <div class="img-box3">
                    <div class="img1">
                        <img src="{{ asset('frontend/about-img.png.jpg') }}"alt="About">
                    </div>
                    <div class="img2 jump">
                        <img src="{{ asset('frontend/abt-1.jpg') }}"alt="img">
                    </div>
                    <div class="about-shape3-1 jump-reverse">
                        <div class="color-masking2">
                            <div class="masking-src" data-mask-src="{{ asset('frontend/shape/about_shape1_1.png') }}"></div>
                            <img src="{{ asset('frontend/shape/about_shape1_1.png') }}" alt="img">
                        </div>
                    </div>
            ...
            <div class="col-xl-6">
                ...
                <div class="about-wrap3">
                    ...
                    <div class="about-feature-grid">
                        <div class="box-icon">
                            <img src="{{ asset('frontend/icon/about-icon3-1.svg') }}" alt="icon">
                        </div>
 ...
 <!--============================== Counter Area ==============================-->
    ...
    <div class="cta-area-1">
        <div class="container z-index-common " data-pos-for="#donation-sec" data-sec-pos="bottom-half">
            <div class="row gy-4">
                <div class="col-lg-6">
                    <div class="cta-card" data-bg-src="{{ asset('frontend/bg/cta-bg1-1.jpg') }}">
                        <div class="shape-mockup cta-card-bg-shape" data-bottom="0" data-right="0" data-mask-src="{{ asset('frontend/shape/cta_shape1_1.png') }}">
                            <img src="{{ asset('frontend/shape/cta_shape1_1.png') }}" alt="img">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="cta-card style2" data-bg-src="{{ asset('frontend/bg/cta-bg1-2.jpg') }}">
                        <div class="shape-mockup cta-card-bg-shape" data-bottom="0" data-left="0" data-mask-src="{{ asset('frontend/shape/cta_shape1_1.png') }}">
                            <img src="{{ asset('frontend/shape/cta_shape1_1.png') }}" alt="img">
                        </div>
    ...
    <section class="space bg-gray" data-bg-src="{{ asset('frontend/bg/donation-bg1-1.png') }}" id="donation-sec">
        <div class="shape-mockup donation-bg-shape1-1" data-bottom="0" data-right="0"><img src="{{ asset('frontend/shape/donation-shape1-1.png') }}" alt="shape"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="title-area text-center">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/dontaing/2.jpg') }}"alt="image">
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="var(--theme-color2)">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/dontaing/health-care.jpg') }}"alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="#FF5528">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/donation/donation1-2.png') }}" alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/dontaing/3.jpg') }}"alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="blog-details.html">Big charity: build school for poor children</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="var(--theme-color2)">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/dontaing/4.jpg') }}"alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="blog-details.html">Give health support for every homeless poor children</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="donation-card" data-theme-color="#FF5528">
                                <div class="donation-card-shape" data-mask-src="{{ asset('frontend/donation/donation-card-bg-shape1-1.png') }}"></div>
                                <div class="box-thumb">
                                    <img src="{{ asset('frontend/dontaing/5.jpg') }}"alt="image">
                                    <div class="donation-card-tag">85%</div>
                                </div>
                                <div class="box-content">
                                    <h3 class="box-title"><a href="blog-details.html">Construct Dwellings African Impoverished Women</a></h3>
    ...
    <div class="video-area-3">
        <div class="shape-mockup video-bg-shape3-1" data-top="0" data-left="0" data-bottom="0">
            <img src="{{ asset('frontend/shape/video_bg_shape3_1.png') }}" alt="img">
        </div>
        <div class="shape-mockup video-bg-shape3-2" data-top="0" data-right="0" data-bottom="0">
            <img src="{{ asset('frontend/shape/video_bg_shape3_2.png') }}" alt="img">
        </div>
        <div class="video-thumb3-1 video-box-center">
            <img src="{{ asset('frontend/video-bg.jpg') }}"alt="img">
            ...
            <div class="row gy-40 gx-80 justify-content-between flex-row-reverse align-items-center">
                <div class="col-xl-7">
                    <div class="story-img-box1">
                        <div class="img1">
                            <img src="{{ asset('frontend/we-help.jpg') }}"alt="img">
                        </div>
                        <div class="story-shape1-1 jump-reverse">
                            <img src="{{ asset('frontend/shape/story_shape1_1.png') }}" alt="img">
                        </div>
                        <div class="story-card movingX">
                            ...
                            <div class="quote-icon" data-mask-src="{{ asset('frontend/icon/quote.svg') }}"></div>
                        </div>
    ...
    <section class="space-bottom team-area-1">
        <div class="shape-mockup team-bg-shape1-1 spin d-xxl-block d-none" data-top="0%" data-right="3%"><img src="{{ asset('frontend/shape/hand-group-shape1.png') }}" alt="img"></div>
        <div class="container">
            <div class="title-area text-center">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card">
                                <div class="img-wrap">
                                    <div class="team-img">
                                        <img src="{{ asset('frontend/team/team_1_1.png') }}" alt="Team">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card">
                                <div class="img-wrap">
                                    <div class="team-img">
                                        <img src="{{ asset('frontend/team/team_1_2.png') }}" alt="Team">
                                    </div>
                                    <div class="team-social-hover">
                                        <a href="#" class="team-social-hover_btn">
                                            <i class="far fa-plus"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card">
                                <div class="img-wrap">
                                    <div class="team-img">
                                        <img src="{{ asset('frontend/team/team_1_3.png') }}" alt="Team">
                                    </div>
                                    <div class="team-social-hover">
                                        <a href="#" class="team-social-hover_btn">
                                            <i class="far fa-plus"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-card">
                                <div class="img-wrap">
                                    <div class="team-img">
                                        <img src="{{ asset('frontend/team/team_1_4.png') }}" alt="Team">
                                    </div>
                                    <div class="team-social-hover">
                                        <a href="#" class="team-social-hover_btn">
                                            <i class="far fa-plus"></i>
    ...
    <div class="video-area-2 space bg-theme-dark overflow-hidden">
        <div class="shape-mockup video-bg-shape2-1" data-top="0" data-left="0" data-bottom="0">
            <img src="{{ asset('frontend/shape/video_shape2_1.png') }}" alt="img">
        </div>
        <div class="container">
            <div class="row gy-40 gx-80 justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="donation-card style2">
                        <div class="box-thumb">
                            <img src="{{ asset('frontend/donation/donation2-1.png') }}" alt="image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title"><a href="blog-details.html">Big charity: build school for poor children</a></h3>
                ...
                <div class="col-lg-6">
                    <div class="video-thumb2-1 video-box-center">
                        <img src="{{ asset('frontend/donate-now.jpg') }}"alt="img">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testi-card3">
                                <div class="testi-card-shape" data-mask-src="{{ asset('frontend/testi-bg.png') }}"></div>
    ...
    <section class="overflow-hidden">
        <div class="project-wrap1 space th-radius overflow-hidden" data-bg-src="{{ asset('frontend/bg/gray-bg2.png') }}" data-overlay="gray" data-opacity="5">
            <div class="shape-mockup project-bg-shape1-1" data-top="0" data-right="0">
                <img src="{{ asset('frontend/shape/project-shape1-1.png') }}" alt="img">
            </div>
           <!-- Swiper CSS -->
                ...
                <div class="swiper th-slider" id="testiSlide4" data-slider-options='{"autoHeight": "true","breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"1"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="project-card">
                                <div class="project-img">
                                    <img src="{{ asset('frontend/project/project_1_1.png') }}" alt="project image">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="project-card">
                                <div class="project-img">
                                    <img src="{{ asset('frontend/project/project_1_3.png') }}" alt="project image">
                                </div>
                                <div class="project-content">
                                    <h3 class="project-title"><a href="project-details.html">Compassion Connect</a></h3>
                                    <p class="project-subtitle">Stronger Community</p>
                        ...
                        <div class="swiper-slide">
                            <div class="project-card">
                                <div class="project-img">
                                    <img src="{{ asset('frontend/project/project_1_2.png') }}" alt="project image">
                                </div>
                                <div class="project-content">
                                    <h3 class="project-title"><a href="project-details.html">Compassion Connect</a></h3>
                                    <p class="project-subtitle">Stronger Community</p>
    ...
    <!--============================== Faq Area ==============================-->
    <div class="space overflow-hidden faq-area-2" data-bg-src="{{ asset('frontend/faqs.jpg') }}">
        <div class="shape-mockup faq-shape2-1 jump-reverse" data-top="20%" data-left="0">
            <img src="{{ asset('frontend/shape/hand-bg-shape2-1.png') }}" alt="img">
        </div>
        <div class="container">
            <div class="row gy-60 gx-60">
                ...
                <div class="col-xl-5">
                    <div class="faq-img-box2">
                        <div class="img1">
                            <img src="{{ asset('frontend/normal/faq_2_1.png') }}" alt="img">
                        </div>
                        <div class="faq-img-shape">
                            <img src="{{ asset('frontend/shape/faq-shape2-1.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>

...
@section('section')
 ...
 <div class="breadcumb-wrapper position-relative">
    ...
    <div class="d-none d-md-block">
        <img src="{{ asset('frontend/assets/img/new_2026/Ration_distribution.png') }}"
    ...
    <div class="d-block d-md-none">
        <img src="{{ asset('frontend/assets/img/mobile-imag/raton.png') }}"
             class="img-fluid w-100"
                ...
                <div class="col-md-6 col-xxl-auto col-lg-4 filter-item">
                    <div class="gallery-card">
                        <div class="gallery-img">
                            <img src="{{ asset('frontend/assets/img/poor-faimly-help/1.webp') }}" alt="gallery image">
                            <a href="{{ asset('frontend/assets/img/poor-faimly-help/1.webp') }}" class="icon-btn popup-image"><i class="fas fa-eye"></i></a>
                        </div>

...
@section('section')
 ...
 <div class="breadcumb-wrapper position-relative">
    ...
    <div class="d-none d-md-block">
        <img src="{{ asset('frontend/assets/img/banner-26-jan/Wheelchair-disr.png') }}"
    ...
    <div class="d-block d-md-none">
        <img src="{{ asset('frontend/assets/img/mobile-imag/wheelchair.png') }}"
             class="img-fluid w-100"

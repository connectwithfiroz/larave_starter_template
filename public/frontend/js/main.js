(function ($) {
  ...
  document.addEventListener("click", function (event) {
    if (!document.getElementById("language-toggler").contains(event.target) &&
        !document.getElementById("language-dropdown").contains(event.target)) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let whatsappPopup = document.getElementById("whatsappPopup");
    ...
    document.addEventListener("click", function (event) {
        if (!whatsappPopup.contains(event.target) && !whatsappIcon.contains(event.target)) {
            whatsappPopup.classList.remove("show");
        }
    });
});
